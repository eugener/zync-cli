//! True Nested Subcommand Example - Hierarchical CLI with unlimited depth
//!
//! This example demonstrates true nested subcommands using Commands types,
//! enabling Git-style and Docker-style CLI tools with deep hierarchies:
//! - myapp db migrate up --steps 1
//! - myapp git remote add origin https://github.com/user/repo.git
//! - myapp docker container run --detach nginx
